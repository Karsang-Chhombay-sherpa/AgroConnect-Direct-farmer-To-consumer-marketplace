        ...
        <div className={styles.formContainer}>
          <div className={styles.formContent}>
            ...
            <div className={styles.header}>
              ...
              <p className={styles.subtitle}>Register your farm business with AgroConnect</p>
            </div>
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              {errorMessage && (
                <div style={{ color: "#ef4444", fontSize: "14px", padding: "12px", background: "#fef2f2", borderRadius: "8px", border: "1px solid #ef4444", textAlign: "center" }}>
                  ✗ {errorMessage}
                </div>
              )}
              <button
